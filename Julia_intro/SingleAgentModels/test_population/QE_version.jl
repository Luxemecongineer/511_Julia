# from https://lectures.quantecon.org/jl/wald_friedman.html
using Distributions
...
"""
function bellman_operator_QE(pgrid::AbstractVector, c::Real,
...
# To solve
pg = linspace(0, 1, 251)
J1 = compute_fixed_point(x -> bellman_operator_QE(pg, 0.5, f0, f1, 5.0, 5.0, x),
